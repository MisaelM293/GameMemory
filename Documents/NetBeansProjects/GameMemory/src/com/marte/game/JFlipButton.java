...
public class JFlipButton extends JComponent implements MouseListener {
    ...
    //iconos por defecto
    private Icon iconBack                   =       new ImageIcon(getClass().getResource("/com/marte/game/resources/9.jpg"));
    private Icon iconFront                  =       new ImageIcon(getClass().getResource("/com/marte/game/resources/Signo.jpg"));
    ...
    public void setNameCharacter(String nameCharacter) {
        ...
        iconBack = new ImageIcon(getClass().getResource("/com/marte/game/resources/"+ this.nameCharacter +".jpg"));
    }
